function UnityProgress(dom) {
    ...
    */
    ...
    backgroundImg.style.tableLayout = "fixed"; //table-layout:fixed
    backgroundImg.style.verticalAlign = "bottom";
    backgroundImg.style.fontSize = "30px";
    backgroundImg.style.top = "50%";
    backgroundImg.style.transform = "translate(0, -50%)";
    backgroundImg.style.backgroundColor = "#000";
    backgroundImg.style.color = "#fff";
    backgroundImg.innerHTML = "<span id='ldg' style='position: absolute; bottom: 0;left: 0;'>loading...</span>";
    background.appendChild(backgroundImg);
